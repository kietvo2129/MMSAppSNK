            ...
            public void onClick(View view) {
                if (idchon == -1){
                    ...
                    if (lotCompositeMasterArrayList.get(idchon).getUse_yn().equals("Y")){
                        new docJSONfinish().execute("http://snk.autonsi.com/Lot/chane_mapping_api?id=" + lotCompositeMasterArrayList.get(idchon).getWmmid()+ "&level=" + level);
                        Log.d("Finsish","http://snk.autonsi.com/Lot/chane_mapping_api?id=" + lotCompositeMasterArrayList.get(idchon).getWmmid()+ "&level=" + level);
                    }
                }
            }
        });
