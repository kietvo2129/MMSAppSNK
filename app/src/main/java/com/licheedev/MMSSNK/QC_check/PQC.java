...
public class PQC extends AppCompatActivity {
    ...
    private void LoadQcListAgain() {
        ...
        String url2 = "http://snk.autonsi.com/product/GetDataFaclineQc?item_vcd=" + Ma_QC_Code + "&olddno=" + olddnochon;
    ...
    private void PopUpQcCheckDetail(int position) {
        ...
        final String ITEM_MQNO = qcitem.get(position).getIdMqno();

        if (!qcitem.get(position).getDefectqty().trim().equals("null")) {
            DefectQtyMax = Integer.parseInt(qcitem.get(position).getDefectqty().trim());
        } else {
            DefectQtyMax = 0;
        }
        //anh xa
        ...
        btn_Save_Detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ITEM_CHECK_QTY_S.length() > 1 && ITEM_MQ_HNO_S.length() > 1) {
                    ...
                    String url = "http://snk.autonsi.com/product/Update_m_facline_qc_value?fqno=" + ITEM_MQNO +
