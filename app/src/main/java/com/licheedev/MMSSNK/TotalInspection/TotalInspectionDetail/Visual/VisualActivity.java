package com.licheedev.MMSSNK.TotalInspection.TotalInspectionDetail.Visual;
...
import com.licheedev.MMSSNK.TotalInspection.TotalInspectionDetail.Thinkness.QcCheckThinknessAdapter;
import com.licheedev.MMSSNK.TotalInspection.TotalInspectionDetail.Thinkness.QcCheckThinknessItem;
...
public class VisualActivity extends AppCompatActivity {
    ...
    private void loaddata() {
        new getData().execute("http://snk.autonsi.com/TotalInspection/list_data_visual?pno=" + idPLno);
        Log.d("getData", "http://snk.autonsi.com/TotalInspection/list_data_visual?pno=" + idPLno);
    }
        ...
        btn_check_save_ck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (numOk == 0 && numDefecty ==0){
                    ...
                    new SaveData_Check().execute("http://snk.autonsi.com/TotalInspection/save_thickness_visual?pino=" + idPLno + "&ti_cd=" + "TI0002" + "&ok_qty=" + numOk + "&def_qty=" + numDefecty);
                    Log.d("SaveData_Check", "http://snk.autonsi.com/TotalInspection/save_thickness_visual?pino=" + idPLno + "&ti_cd=" + "TI0002" + "&ok_qty=" + numOk + "&def_qty=" + numDefecty);
                    alertDialog.dismiss();
                }
