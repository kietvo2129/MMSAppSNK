...
//        // Anh xa
        ...
        String UrlgetInput_mpo_no = "http://snk.autonsi.com/product/getDatainput_PQC?";
    ...
    private void ItemProcess() {
        ...
        spinnerWO.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                new docJSON_inputProcess().execute("http://snk.autonsi.com/product/getDatainput_PQC?fo_no=" + mpono);
                Log.d("docJSON_inputProcess", "http://snk.autonsi.com/product/getDatainput_PQC?fo_no=" + mpono);
            }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (object.getString("result").equals("[]")) {
                    ...
                    buildListView();
                    new docJSON_inputdate().execute("http://snk.autonsi.com/product/getDatainput_PQC?fo_no=" + mpono + "&process=" + "");
                    Log.d("docJSON_inputdate", "http://snk.autonsi.com/product/getDatainput_PQC?fo_no=" + mpono + "&process=" + "");
                } else {
                    JSONArray jsonArray = object.getJSONArray("result");
                    for (int i = 0; i < jsonArray.length(); i++) {
                        String mpo_no = jsonArray.getString(i);
    ...
    private void ItemDate() {
        ...
        spinnerProcess.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                new docJSON_inputdate().execute("http://snk.autonsi.com/product/getDatainput_PQC?fo_no=" + mpono + "&process=" + Process);
                Log.d("docJSON_inputdate", "http://snk.autonsi.com/product/getDatainput_PQC?fo_no=" + mpono + "&process=" + Process);
            }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (object.getString("result").equals("[]")) {
                    ...
                    tvCheckQty.setText("");
                    tvOkeQty.setText("");
                    new docJSON_inputdata().execute("http://snk.autonsi.com/product/GetListDay_PQC?fo_no=" + mpono + "&process=" + Process + "&work_ymd=" + "");
                    Log.d("docJSON_inputdata", "http://snk.autonsi.com/product/GetListDay_PQC?fo_no=" + mpono + "&process=" + Process + "&work_ymd=" + "");
                } else {
                    JSONArray jsonArray = object.getJSONArray("result");
                    for (int i = 0; i < jsonArray.length(); i++) {
                        String mpo_no = jsonArray.getString(i);
    ...
    private void ItemData() {
        ...
        spinnerDate.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                new docJSON_inputdata().execute("http://snk.autonsi.com/product/GetListDay_PQC?fo_no=" + mpono + "&process=" + Process + "&work_ymd=" + date);
                Log.d("docJSON_inputdata", "http://snk.autonsi.com/product/GetListDay_PQC?fo_no=" + mpono + "&process=" + Process + "&work_ymd=" + date);
            }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (object.getString("result").equals("[]") || object.getString("result").equals("false")) {
                    Toast.makeText(getContext(), "Data incorrect....", Toast.LENGTH_SHORT).show();
                    String url2 = "http://snk.autonsi.com/product/GetDataFaclineQc?item_vcd=" + "" + "&olddno=" + olddno;
    ...
    private void LoadQcListAgain() {
        if (!Ma_QC_Code.equals("null")) {
            String url2 = "http://snk.autonsi.com/product/GetDataFaclineQc?item_vcd=" + Ma_QC_Code + "&olddno=" + olddno;
            Log.d("PQC_getData", url2);
            new LoadQcList().execute(url2);
        }else {
...
//                // item
    ...
    private void PopUpQcCheckDetail(int position) {
        ...
        String url = "http://snk.autonsi.com/product/GetDataFaclineQc_detail?fq_no=" + qcitem.get(position).getMq_no();
